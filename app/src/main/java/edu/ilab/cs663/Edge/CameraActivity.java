...
import edu.ilab.cs663.localize.CameraConnectionFragment;
import edu.ilab.cs663.localize.LegacyCameraConnectionFragment;
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA)) {
                Toast.makeText(
                        edu.ilab.cs663.Edge.CameraActivity.this,
                    ...
                    CameraConnectionFragment.newInstance(
                            new CameraConnectionFragment.ConnectionCallback() {
                                ...
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                    ...
                                    edu.ilab.cs663.Edge.CameraActivity.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
