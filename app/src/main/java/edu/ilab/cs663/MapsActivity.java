...
/**
 * Main Launched Activity that contains our Map for CS663 project
 */
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exampleDetectorActivityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Launch classifier --here stupid default flowers classifier
                Intent intent = new Intent("edu.ilab.cs663.localize.DetectorActivity");
                startActivity(intent);
            }
        });

        Button edge = (Button) findViewById(R.id.edgebtn);
        edge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent("edu.ilab.cs663.Edge.EdgeActivity");
                startActivity(intent);
            }
        });
